export default {
	...
	'serial-input-header-text': 'Serial Input',
	'serial-input-sub-header': 'USB Serial Input Configuration',
	'serial-input-description-1':
		'The Serial Input addon allows you to send gamepad button states via USB Serial (CDC) instead of using physical buttons.',
	'serial-input-description-2':
		'Send a 4-byte uint32_t (little-endian) where each bit represents a button (1 = pressed, 0 = released). Rate: up to 120 Hz.',
	'serial-input-protocol-label': 'Protocol - Bit Mapping:',
	'serial-input-bit-0': 'Bit 0',
	'serial-input-bit-1': 'Bit 1',
	'serial-input-bit-2': 'Bit 2',
	'serial-input-bit-3': 'Bit 3',
	'serial-input-bit-4': 'Bit 4',
	'serial-input-bit-5': 'Bit 5',
	'serial-input-bit-6': 'Bit 6',
	'serial-input-bit-7': 'Bit 7',
	'serial-input-bit-8': 'Bit 8',
	'serial-input-bit-9': 'Bit 9',
	'serial-input-bit-10': 'Bit 10',
	'serial-input-bit-11': 'Bit 11',
	'serial-input-bit-12': 'Bit 12',
	'serial-input-bit-13': 'Bit 13',
	'serial-input-bit-14': 'Bit 14',
	'serial-input-bit-15': 'Bit 15',
	'serial-input-example-label': 'Python Example:',
};
